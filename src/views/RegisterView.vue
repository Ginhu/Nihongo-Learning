  ...
  <div class="min-h-screen flex items-center justify-center p-4 bg-[var(--color-bg)]">
    <div class="w-full max-w-md">
      ...
      <div class="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl p-8 shadow-lg">
        <h2 class="text-xl font-semibold text-[var(--color-text)] mb-6">Create Account</h2>
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <div>
            <label class="block text-sm font-medium text-[var(--color-text-muted)] mb-1">Username</label>
            <input
              v-model="username"
              type="text"
              required
          ...
          <div>
            <label class="block text-sm font-medium text-[var(--color-text-muted)] mb-1">Confirm Password</label>
            <input
        ...
        <div class="space-y-3">
          <button
            @click="oauthGoogle"
            class="w-full flex items-center justify-center gap-3 py-2.5 rounded-lg border border-[var(--color-border)] bg-[var(--color-surface-2)] text-[var(--color-text)] hover:bg-[var(--color-border)] transition font-medium"
          >
        ...
        <p class="mt-6 text-center text-sm text-[var(--color-text-muted)]">
          ...
          <button @click="router.push('/login')" class="text-[var(--color-primary)] font-medium hover:underline ml-1">
            Sign in
          </button>
        </p>
      </div>
